    ...
    return (
        <div className="mt-12">
            <div className="flex justify-between items-center mb-4">
                <div className={`flex gap-3 ${step === "checkout" ? "cursor-pointer" : ""}`} 
                     onClick={() => step === "checkout" && setStep("bag")}>
                ...
                <div className={`flex gap-3 ${step === "order" ? "cursor-pointer" : ""}`}
                     onClick={() => step === "order" && setStep("checkout")}>
