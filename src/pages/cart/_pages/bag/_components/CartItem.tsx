...
const CartItem = ({ item, onUpdateQuantity, onRemoveItem, onSelectItem }: CartItemProps) => {
    ...
    // Debounce cho checkbox
    const debouncedSelect = useDebounce((selected: boolean) => {
        onSelectItem(item._id, selected);
    }, 200);
    ...
    const handleCheckboxChange = (e: React.ChangeEvent<HTMLInputElement>) => {
        ...
        debouncedSelect(newSelected);
    };

    // Cập nhật localSelected khi item.selected thay đổi từ props
    useEffect(() => {
            ...
            <div className="py-4 px-3 flex flex-col sm:grid sm:grid-cols-12 gap-4 items-start sm:items-center">
                ...
                <div className="flex items-center gap-5 sm:gap-9 sm:pl-0 sm:col-span-3">
                    ...
                    <div className="flex flex-col gap-2">
                        ...
                        {isMaxStock && <p className="text-xs text-red-500">Hết hàng</p>}
                    </div>
                </div>
