...
//         <h2 className="text-[#222] text-center text-[25px] sm:text-[35px] not-italic font-normal uppercase mb-10">
//           Testimonials
//         </h2>
...
//           <div className="flex justify-between items-center absolute top-1/2 left-0 right-0 px-4 xl:px-40 2xl:px-0">
//             <button onClick={prev}>
