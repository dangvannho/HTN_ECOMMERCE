...
const Hero = () => {
    ...
    return (
        <div className="relative flex flex-col lg:flex-row justify-center overflow-hidden pt-7 px-[20px] lg:px-[130px] bg-[#fff]">
            {/* cột trái  */}
            ...
            <div className="relative w-full lg:w-1/2 h-[50vh] sm:h-[60vh] lg:h-[80vh] flex items-center justify-center order-1 lg:order-2">
                ...
                <div className="w-full h-full lg:w-[350px] overflow-hidden relative">
                    {/* Đường tròn ẩn */}
